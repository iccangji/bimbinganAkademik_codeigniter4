    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>">
                ...
                <div class="sidebar-brand-text" style="font-size: 12px"> Sistem Bimbingan Akademik</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Footer -->
                <footer class="sticky-footer bg-white p-0">
                    <div class="container my-auto fixed-bottom">
                        <div class=" copyright text-center my-auto">
                            <span>Web by Icang</span>
                        </div>
                </footer>
                <!-- End of Footer -->
        ...
        <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">Anda yakin keluar dari akun ini?</div>
